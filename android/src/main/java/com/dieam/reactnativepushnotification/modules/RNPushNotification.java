...
public class RNPushNotification extends ReactContextBaseJavaModule implements ActivityEventListener {
    ...
    @ReactMethod
    /**
     * Cancel scheduled notification, and removes notification from the notification centre.
     *
     */
    public void cancelLocalNotification(String notificationIDString) {
        mRNPushNotificationHelper.cancelScheduledNotificationIfExist(notificationIDString);
    }
